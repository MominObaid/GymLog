...
import com.example.gymlog.domain.usecase.AnalyzeWorkoutPerformanceUseCase
import com.example.gymlog.domain.usecase.GenerateWorkoutPlanUseCase
import com.example.gymlog.domain.usecase.GetDashboardStatsUseCase
import com.example.gymlog.domain.usecase.GetFatigueScoreUseCase
import com.example.gymlog.domain.usecase.GetMuscleVolumeUseCase
import com.example.gymlog.domain.usecase.GetOneRMHistoryUseCase
import com.example.gymlog.domain.usecase.GetRecoveryScoreUseCase
import com.example.gymlog.domain.usecase.PredictFitnessProgressUseCase
import com.example.gymlog.domain.usecase.SaveWorkoutSessionUseCase
import com.example.gymlog.domain.usecase.SuggestExerciseSubstitutionUseCase
import com.example.gymlog.domain.usecase.UpdateMilestonesUseCase
